    ...
    return (
      <div className="space-y-7">
        ...
        <section className="rounded-3xl border border-emerald-400/25 bg-slate-900 p-4 sm:p-7">
          <div className="mb-5 text-center"><p className="text-sm font-black tracking-[0.2em] text-emerald-300">🏆 TOP 11 DELLA SETTIMANA</p><h3 className="mt-1 text-2xl font-black">Modulo ufficiale 3-5-2</h3></div>
  ...
  return (
    <div className="space-y-7">
      <section className="rounded-3xl border border-emerald-400/25 bg-gradient-to-br from-emerald-400/10 via-slate-900 to-slate-900 p-6 sm:p-8">
        <p className="text-sm font-black uppercase tracking-[0.2em] text-emerald-300">CALCIO TOTALE</p>
        <h2 className="mt-2 text-3xl font-black">⭐ Votazioni partita</h2>
        <p className="mt-2 text-sm text-slate-400">Voti, commenti, media e classifica sono salvati nel database.</p>
